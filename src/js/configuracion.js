...
async function cargarConfig() {
  ...
  document.getElementById('b-frase-libro').value  = data.b_frase_libro  || 'En el libro de bautismos';
  ...
  document.getElementById('c2-frase-libro').value  = data.c2_frase_libro  || 'En el libro de confirmaciones';
  ...
  document.getElementById('co-frase-libro').value  = data.co_frase_libro  || 'En el libro de primeras comuniones';
  ...
  document.getElementById('m-frase-libro').value    = data.m_frase_libro    || 'En el libro de matrimonios';
...
function verPreview(tipo) {
  ...
  if (tipo === 'bautismo') {
    intro  = `${config.b_frase_inicio} ${parroquia}, CERTIFICA QUE:\n${config.b_frase_libro} N.° 48, folio 124, asiento 496, se encuentra la partida que literalmente dice:`;
    ...
    intro  = `${config.c2_frase_inicio} ${parroquia}, CERTIFICA QUE:\n${config.c2_frase_libro} N.° 12, folio 45, asiento 123, se encuentra la partida que literalmente dice:`;
    ...
    intro  = `${config.co_frase_inicio} ${parroquia}, CERTIFICA QUE:\n${config.co_frase_libro} N.° 08, folio 32, asiento 201, se encuentra la partida que literalmente dice:`;
    ...
    intro  = `${config.m_frase_inicio} ${parroquia}, CERTIFICA QUE:\n${config.m_frase_libro} N.° 05, folio 18, asiento 089, se encuentra la partida que literalmente dice:`;
